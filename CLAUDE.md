...
./scripts/demo-entropy.sh 3              # run specific module (0-78)
./scripts/demo-entropy.sh --dry-run      # dry-run mode
./scripts/demo-entropy.sh --score        # automated 79-module scorecard
